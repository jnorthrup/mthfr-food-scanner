      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            {ingredient.originalText.toLowerCase() !==
              ingredient.canonicalName.toLowerCase() && (
        ...
        <AccordionItem value={`ing-${index}`} className="border-0">
          ...
          >
            <div className="flex items-center gap-3 flex-1">
              <StatusIcon
                className={cn("w-5 h-5 flex-shrink-0", config.color)}
              />
          ...
          <AccordionContent className="px-3 pt-2 pb-3">
            <div className="space-y-3 pl-8">
              {ingredient.safetyReason && (
                <div
                  data-design-id={`safety-reason-${index}`}
              ...
              {ingredient.isMasking && ingredient.maskingReason && (
                <div
                  data-design-id={`masking-reason-${index}`}
                  className="flex items-start gap-2 text-sm bg-violet-50 dark:bg-violet-950/30 rounded-lg p-2"
                >
              ...
              {ingredient.subIngredients &&
                ingredient.subIngredients.length > 0 && (
                  <div
                    data-design-id={`sub-ingredients-${index}`}
                    className="space-y-2"
                  >
                    ...
                    <div className="space-y-1.5 pl-2 border-l-2 border-muted">
                      {ingredient.subIngredients.map((sub, subIndex) => {
                        ...
                        return (
                          ...
                          >
                            <SubIcon
                              className={cn("w-4 h-4", subConfig.color)}
                            />
              ...
              <div
                data-design-id={`confidence-${index}`}
  ...
  return (
    <TooltipProvider>
      <div data-design-id="ingredient-list" className="space-y-2">
        <div
          data-design-id="ingredient-list-header"
