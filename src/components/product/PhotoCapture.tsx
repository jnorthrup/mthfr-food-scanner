  ...
  if (!hasPhotoConsent) {
    return (
      <div data-design-id="photo-no-consent" className="p-6 text-center">
        ...
        <h3 data-design-id="no-consent-title" className="font-semibold mb-2">
          Photo Permission Required
        </h3>
        <p
          data-design-id="no-consent-desc"
          className="text-sm text-muted-foreground mb-4"
        >
          Enable photo upload permission in Settings to use OCR ingredient
          scanning.
        </p>
        {onCancel && (
    ...
    <div data-design-id="photo-capture" className="space-y-4">
      ...
      {state === "idle" && (
        ...
        >
          ...
          <div>
            <h3 data-design-id="capture-title" className="font-semibold mb-1">
              Scan Ingredient Label
            </h3>
            <p
              data-design-id="capture-desc"
      ...
      {state === "success" && ocrResult && (
        ...
        >
          ...
          <div className="flex gap-3">
            ...
            <Button
              onClick={() =>
                onIngredientsExtracted(ocrResult.ingredients, ocrResult.text)
              }
              className="flex-1"
            >
